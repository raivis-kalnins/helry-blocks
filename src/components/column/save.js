...
export default function save( { attributes } ) {
	...
	const mediaStyle = {
		...
		backgroundAttachment: bgAttach && ( `fixed` ) || `inherit`
	};
	...
	const { colId } = attributes;

	return (
		<div id={ colID } { ...useBlockProps.save( { id: colId, className: classNameCol } ) } style={ mediaStyle } >
