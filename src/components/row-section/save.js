 ...
 */
 ...
 export default function save( { attributes } ) {
	...
	const overlayStyle = {
	 ...
	 return (
		 <div id={ sectionID } { ...useBlockProps.save( { className: classNameRow } ) } style={ mediaStyle }>
