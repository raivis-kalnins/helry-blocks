 ...
 */
  ...
  * @type {string[]}
  */
 const ALLOWED_BLOCKS = [ 'dpwpblocks/column' ];
	 ...
	 return (
		 <>
			 <InspectorControls>
				...
				<PanelBody title={'Anchor (row ID)'} initialOpen={ false }>
					<InputControl
						...
						type="anchor"
						isPressEnterToChange
						onChange={ ( newStyle ) => setAttributes( {sectionID: newStyle} ) }
					/>
				</PanelBody>
			 </InspectorControls>
			 <i class="scap scap__top"> Start row/section </i>
			 <div { ...innerBlocksProps } />
			 <i class="scap scap__bottom"> //End row/section </i>
		 </>
	 );
 }
